...
try {
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $stmt = $conn->prepare("SELECT * FROM tbl_orders_a174088, tbl_staffs_a174088,
      tbl_customers_a174088, tbl_orders_details_a174088 WHERE
      tbl_orders_a174088.fld_staff_num = tbl_staffs_a174088.fld_staff_num AND
      tbl_orders_a174088.fld_customer_num = tbl_customers_a174088.fld_customer_num AND
  ...
  try {
    ...
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
      $stmt = $conn->prepare("SELECT * FROM tbl_orders_details_a174088,
        tbl_products_a174088 where 
        tbl_orders_details_a174088.fld_product_num = tbl_products_a174088.fld_product_num AND
        fld_order_num = :oid");
    $stmt->bindParam(':oid', $oid, PDO::PARAM_STR);
      $oid = $_GET['oid'];
    $stmt->execute();
