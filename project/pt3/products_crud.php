...
if (isset($_POST['create'])) {
  ...
  try {
      ...
      $stmt = $conn->prepare("INSERT INTO tbl_products_a174088(fld_product_num,
...
if (isset($_POST['update'])) {
  ...
  try {
      ...
      $stmt = $conn->prepare("UPDATE tbl_products_a174088 SET fld_product_num = :pid,
...
if (isset($_GET['delete'])) {
  ...
  try {
      ...
      $stmt = $conn->prepare("DELETE FROM tbl_products_a174088 WHERE fld_product_num = :pid");
...
if (isset($_GET['edit'])) {
  ...
  try {
      ...
      $stmt = $conn->prepare("SELECT * FROM tbl_products_a174088 WHERE fld_product_num = :pid");
