...
if (isset($_POST['biodata_form'])) {
 ...
 if (isset($_POST['sex']) && ($_POST['sex'] != ""))
  ...
  {
    $msg .= "Error: Please insert your favorite color.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please insert a Fb/TW/IG.<br>";
    $count_error++;
  }
...
<form action="save_biodata.php" method="post">
  <table border="1" cellpadding="10">
    ...
    <tr>
      <td>Height:</td>
      <td><?php echo $height; ?><input type="hidden" name="height" value="<?php echo $height; ?>"> cm</td>
    </tr>
    <tr>
      <td>Tel:</td>
